/*! ----------------------------------------------------------------------------
 *  @file    main.c
 *  @brief   µ¥²àË«Ïò²â¾àÏìÓ¦ÕßÊ¾Àý´úÂë(SS TWR)//Single-sided two-way ranging (SS TWR) responder example code
 *
 *           yuanqd:ÕâÊÇÒ»¸ö¼òµ¥Ê¾Àý´úÂë£¬ÔÚSS TWR¾àÀë²âÁ¿½»»»ÖÐ°çÑÝÏìÓ¦ÕßµÄ½ÇÉ«¡£Õâ¸ö³ÌÐòµÈ´ýÒ»¸ö"poll"ÏûÏ¢£¬£¨¼ÇÂ¼ÁËpollµÄRXÊ±¼ä´Á£©//This is a simple code example which acts as the responder in a SS TWR distance measurement exchange. This application waits for a "poll"
